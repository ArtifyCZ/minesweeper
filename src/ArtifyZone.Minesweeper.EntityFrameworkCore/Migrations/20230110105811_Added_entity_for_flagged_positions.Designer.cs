...
namespace ArtifyZone.Minesweeper.Migrations
{
    ...
    [Migration("20230110105811_Added_entity_for_flagged_positions")]
    partial class Addedentityforflaggedpositions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ArtifyZone.Minesweeper.Game.FlaggedPosition", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppFlaggedPositions", (string)null);
                });

            modelBuilder.Entity("ArtifyZone.Minesweeper.Game.Game", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ArtifyZone.Minesweeper.Game.MinePosition", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppMinePositions", (string)null);
                });

            modelBuilder.Entity("ArtifyZone.Minesweeper.Game.RevealedPosition", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppRevealedPositions", (string)null);
                });
            ...
            modelBuilder.Entity("ArtifyZone.Minesweeper.Game.FlaggedPosition", b =>
                {
                    b.HasOne("ArtifyZone.Minesweeper.Game.Game", null)
                        .WithMany("FlaggedMines")
            ...
            modelBuilder.Entity("ArtifyZone.Minesweeper.Game.Game", b =>
                {
                    b.Navigation("FlaggedMines");

                    b.Navigation("Mines");

                    b.Navigation("Revealed");
                });
